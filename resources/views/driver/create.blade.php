...
@section('content')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="driver_code" class="form-control"  readonly id="driver_code" value="{{old('driver_code')}}">
                                @error('driver_code')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="gov_id" class="form-control" placeholder="Enter Govt. ID" value="{{old('gov_id')}}" required>
                                @error('gov_id')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="Enter Email (optional)" value="{{old('email')}}">
                                @error('email')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="postal_code" class="form-control" placeholder="Enter Postal Code" value="{{old('postal_code')}}" required>
                                @error('postal_code')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="license_number" class="form-control" value="{{old('license_number')}}" placeholder="Enter License Number" required>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" id="date" placeholder="YY-MM-DD" name="license_expiry_date" value="{{old('license_expiry_date')}}" class="form-control">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="address" rows="2" class="form-control" placeholder="Enter Address">{{old('address')}}</textarea>
                                @error('address')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" placeholder="YY-MM-DD" id="date" name="dob" value="{{old('dob')}}" class="form-control" required>
                                @error('dob')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-3 ">
                                ...
                                <div class="form-check form-check-inline " style="margin-left: 20px;">
                                    <input class="form-check-input" type="radio" name="status" id="activeStatus" value="1" {{old('status')==1?'checked':''}}>
    ...
    <script>
        ...
        window.onload = generateDriverCode;
